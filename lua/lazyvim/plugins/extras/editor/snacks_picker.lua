...
return {
  ...
  recommended = true,
  {
    ...
    keys = {
      ...
      { "<leader>fo", LazyVim.pick("live_grep", { root = false }), desc = "Grep (cwd)" },
  ...
  },
  {
    ...
    opts = function()
      ...
      vim.list_extend(Keys, {
        ...
        { "<leader>fs", function() Snacks.picker.lsp_symbols({ filter = LazyVim.config.kind_filter }) end, desc = "LSP Symbols", has = "documentSymbol" },
        { "<leader>fS", function() Snacks.picker.lsp_workspace_symbols({ filter = LazyVim.config.kind_filter }) end, desc = "LSP Workspace Symbols", has = "workspace/symbols" },
      })
    end,
  },
  {
